"""AlgoIdentity [Inductive] — RL algorithm sum type (ADT, 4 variants).
...
Shared across TrainHom, ServeHom, TrainProductOutput without cross-Hom imports
because it lives at the Inductive layer, which all higher layers may import.
"""
from enum import Enum


class AlgoIdentity(str, Enum):
    """AlgoIdentity [Inductive] — Named RL algorithm enum for SB3 dispatch (4 variants)."""
    PPO = "PPO"
    SAC = "SAC"
    DQN = "DQN"
    A2C = "A2C"
