...
class DiscoveryProductOutput(BaseModel):
    ...
    min_trend_score_used: float = Field(default=20.0, ge=0.0, le=100.0,
        description="ADX threshold used for filtering — echoed from DiscoveryHom.min_trend_score for audit")
