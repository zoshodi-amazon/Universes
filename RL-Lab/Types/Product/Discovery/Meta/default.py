...
class DiscoveryProductMeta(BaseModel):
    ...
    adx_filtered_count: int = Field(default=0, ge=0, le=100_000,
        description="Tickers filtered out by ADX threshold")
    liquidity_filtered_count: int = Field(default=0, ge=0, le=100_000,
        description="Tickers filtered out by liquidity rules")
    asset_class_filtered_count: int = Field(default=0, ge=0, le=100_000,
        description="Tickers filtered out by asset class routing")
    top_adx_score: float = Field(default=-1.0, ge=-1.0, le=100.0,
