"""FeatureHom [Hom] — Feature phase config (7 params). All bounded."""
...
class FeatureHom(BaseModel):
    """FeatureHom [Hom] — Config for wavelet denoising and trend indicator feature engineering."""
