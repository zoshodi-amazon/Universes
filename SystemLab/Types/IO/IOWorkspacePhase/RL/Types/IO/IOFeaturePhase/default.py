...
def run(
    ...
    store = run_base.store.model_copy(update={"run_id": run_base.run_id, "phase": PhaseId.feature})
    ...
    try:
        ...
        raise ValueError(f"ingest artifact not found in store for run_id={run_base.run_id}")
