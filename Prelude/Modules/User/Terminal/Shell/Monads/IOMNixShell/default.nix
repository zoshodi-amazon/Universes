# IOMNixShell Monad — enables all shells + sets shared aliases/paths
{ config, lib, ... }:
let env = config.shell.env; in
{
  config.shell.aliases = {
    ...
    discover = "nu ~/repos/Universes/Prelude/Modules/Labs/Scripts/Universe/Discover/Bindings/Scripts/default.nu";
  };
