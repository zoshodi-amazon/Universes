...
Train/Eval/Serve symmetry. Stop-loss via native limit orders.
"""
...
class EnvUnit(BaseModel):
    """EnvUnit [Solid] — Trading environment parameters shared across train, eval, and serve."""
    ...
    positions: list[float] = Field(default=[-1.0, 0.0, 1.0], min_length=2, max_length=10, description="Allowed position sizes — -1.0 short, 0.0 flat/cash, 1.0 fully long")
