...
import uuid
from Types.UnitTypes.FieldUnit.default import RunId, DirPath
...
class RunUnit(BaseModel):
    ...
    output_dir: DirPath = Field(default="Env/Outputs", description="Directory path for all phase output artifacts")
